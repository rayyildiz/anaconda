...
func (api TwitterApi) GetActivityWebhooks(v url.Values) (u []WebHookResp, err error) {
	responseCh := make(chan response)
	api.queryQueue <- query{api.baseUrl + "/account_activity/webhooks.json", v, &u, _GET, responseCh}
...
func (api TwitterApi) SetActivityWebhooks(v url.Values) (u []WebHookResp, err error) {
	responseCh := make(chan response)
	api.queryQueue <- query{api.baseUrl + "/account_activity/webhooks.json", v, &u, _POST, responseCh}
	return u, (<-responseCh).err
}
...
func (api TwitterApi) DeleteActivityWebhooks(v url.Values, webhookID string) (u interface{}, err error) {
	responseCh := make(chan response)
	api.queryQueue <- query{api.baseUrl + "/account_activity/webhooks/" + webhookID + ".json", v, &u, _DELETE, responseCh}
	return u, (<-responseCh).err
}
...
func (api TwitterApi) PutActivityWebhooks(v url.Values, webhookID string) (u interface{}, err error) {
	responseCh := make(chan response)
	api.queryQueue <- query{api.baseUrl + "/account_activity/webhooks/" + webhookID + ".json", v, &u, _PUT, responseCh}
	return u, (<-responseCh).err
}
...
func (api TwitterApi) SetWHSubscription(v url.Values, webhookID string) (u interface{}, err error) {
	responseCh := make(chan response)
	api.queryQueue <- query{api.baseUrl + "/account_activity/webhooks/" + webhookID + "/subscriptions.json", v, &u, _POST, responseCh}
	return u, (<-responseCh).err
}
...
func (api TwitterApi) GetWHSubscription(v url.Values, webhookID string) (u interface{}, err error) {
	responseCh := make(chan response)
	api.queryQueue <- query{api.baseUrl + "/account_activity/webhooks/" + webhookID + "/subscriptions.json", v, &u, _GET, responseCh}
	return u, (<-responseCh).err
}
...
func (api TwitterApi) DeleteWHSubscription(v url.Values, webhookID string) (u interface{}, err error) {
	responseCh := make(chan response)
	api.queryQueue <- query{api.baseUrl + "/account_activity/webhooks/" + webhookID + "/subscriptions.json", v, &u, _DELETE, responseCh}
	return u, (<-responseCh).err
}
